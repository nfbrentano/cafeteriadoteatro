-- =========================================================
-- MIGRATION: CAF-000010 - NOME DO CLIENTE E PARA VIAGEM
-- =========================================================

-- 1. Adicionar colunas na tabela de pedidos
ALTER TABLE public.pedidos
  ADD COLUMN IF NOT EXISTS cliente_nome TEXT,
  ADD COLUMN IF NOT EXISTS para_viagem BOOLEAN NOT NULL DEFAULT false;

-- 2. Atualizar a RPC criar_pedido para receber os novos campos
...
BEGIN
  ...
  INSERT INTO public.pedidos (
    mesa_codigo, observacoes, forma_pagamento, status_pagamento, criado_por, criado_por_nome, total, cliente_nome, para_viagem
  )
  VALUES (
    v_mesa_codigo, v_obs_geral, v_forma_pagamento, v_status_pagamento, auth.uid(),
    (SELECT nome FROM public.perfis WHERE id = auth.uid()), 0, v_cliente_nome, v_para_viagem
