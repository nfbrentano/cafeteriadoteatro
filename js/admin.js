...
(function () {
  ...
  const DEFAULT_DATA = {
    ...
    produtos: [
      { id: 'espresso',       categoriaId: 'cafes',     nome: 'Espresso',                 descricao: 'Encorpado, aromático e concentrado. O clássico que nunca falha.',                        preco: 4.00,  imagemUrl: 'assets/images/produto-cafe.webp',    badges: ['popular'], ativo: true, ordem: 1 },
      { id: 'cappuccino',     categoriaId: 'cafes',     nome: 'Cappuccino',               descricao: 'Espresso com leite vaporizado cremoso e leve toque de canela. Quente e reconfortante.',   preco: 9.00,  imagemUrl: 'assets/images/galeria-latte.webp',   badges: ['popular'], ativo: true, ordem: 2 },
      ...
      { id: 'cafe-gelado',    categoriaId: 'geladas',   nome: 'Café Gelado',              descricao: 'Espresso sobre gelo com leite e espuma cremosa. Refrescante e encorpado ao mesmo tempo.', preco: 10.00, imagemUrl: 'assets/images/produto-gelado.webp',  badges: ['popular'], ativo: true, ordem: 1 },
      ...
      { id: 'bolo-dia',       categoriaId: 'doces',     nome: 'Bolo do Dia',              descricao: 'Feito diariamente, sempre fresquinho. Consulte a opção disponível hoje com a gente.',     preco: 9.00,  imagemUrl: 'assets/images/produto-doce.webp',    badges: ['popular'], ativo: true, ordem: 1 },
      ...
      { id: 'croissant',      categoriaId: 'salgados',  nome: 'Croissant de Queijo',      descricao: 'Folhado dourado, recheio de queijo derretido. Crocante por fora, macio por dentro.',      preco: 8.00,  imagemUrl: 'assets/images/produto-salgado.webp', badges: ['popular'], ativo: true, ordem: 1 },
      ...
      { id: 'affogato',       categoriaId: 'especiais', nome: 'Affogato',                 descricao: 'Espresso duplo derramado sobre sorvete de creme. Quente e frio ao mesmo tempo — uma experiência.', preco: 14.00, imagemUrl: 'assets/images/produto-cafe.webp',  badges: ['popular'], ativo: true, ordem: 1, especialBadgeLabel: '🔥 Favorito da Casa', especialBadgeClass: 'badge--popular' },
      { id: 'choc-quente',    categoriaId: 'especiais', nome: 'Chocolate Quente Premium', descricao: 'Chocolate belga 70% fundido com leite integral. Denso, aveludado e inesquecível nos dias frios.', preco: 12.00, imagemUrl: 'assets/images/produto-doce.webp',  badges: [],          ativo: true, ordem: 2 },
      { id: 'chai-latte',     categoriaId: 'especiais', nome: 'Chai Latte',               descricao: 'Blend de especiarias indianas com leite vaporizado. Canela, cardamomo, gengibre e aconchego em cada gole.', preco: 11.00, imagemUrl: 'assets/images/galeria-latte.webp', badges: ['novo'], ativo: true, ordem: 3 }
    ]
  };
