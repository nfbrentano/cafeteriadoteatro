...
// Utilitário para pegar o início do dia no fuso de SP
if (!window.getInicioDoDiaSaoPaulo) {
  window.getInicioDoDiaSaoPaulo = function() {
    ...
    // Retorna ISO no início do dia de São Paulo (-03:00)
